---
title: "Setting Up a Secure Debian Server"
tags:
  - unix
  - sysadmin
  - bash
date: 2024-12-25
image: /images/blog/articles/born2beroot/thumbnail.png
...
The **bonus** involves setting up additional features, like **advanced partitioning**, a **WordPress website** with specific services, or another functional service of your choice. However, bonus evaluation requires the mandatory part to be **flawless**.

[Born2BeRoot.pdf](/images/blog/articles/born2beroot/born2beroot.pdf)
...
<Callout variant="info" title="Screenshots">
![Installation Screen](/images/blog/articles/born2beroot/screenshots/Screenshot%20from%202024-12-23%2007-24-21.webp)
</Callout>
...
<Callout variant="info">
Separating these partitions is usually a good idea for **security** reasons.
>
...
<Callout variant="info" title="Screenshots">
![Screenshot 1](/images/blog/articles/born2beroot/screenshots/Screenshot%20from%202024-12-23%2008-49-34.webp)
![Screenshot 2](/images/blog/articles/born2beroot/screenshots/Screenshot%20from%202024-12-23%2008-49-57.webp)
![Pasted image](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223085721.webp)
Adjust the volume group size in guided partitioning to carve out space for a couple more logical volumes.
![Screenshot 3](/images/blog/articles/born2beroot/screenshots/Screenshot%20from%202024-12-23%2009-03-56-1.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![LVM Configuration](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223091041.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![srv configuration 1](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223091323.webp)
![srv configuration 2](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223091345.webp)
![srv configuration 3](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223091415.webp)
Let's allocate `4000mb` for `/srv`:
![srv allocation](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223091438.webp)
</Callout>
...
<Callout variant="info" title="Screenshots - srv">
![srv format 1](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223092332.webp)
![srv format 2](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102240.webp)
![srv format 3](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102255.webp)
![srv format 4](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102319.webp)
![srv format 5](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102332.webp)
![srv format 6](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102352.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![var-log format](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223102843.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![Installation Media Scan](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223105600.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![Country Selection](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223105711.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![Mirror Selection](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223105747.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![HTTP Proxy](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223105916.webp)
</Callout>
...
<Callout variant="info" title="Screenshots">
![GRUB Boot Loader 1](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223113440.webp)
![GRUB Boot Loader 2](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223113747.webp)
![GRUB Boot Loader 3](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241223121041.webp)
</Callout>
...
![Port Forward Diagram](/images/blog/articles/born2beroot/port_forward.svg)
...
<Callout variant="info" title="Screenshots">
![SSH Connection](/images/blog/articles/born2beroot/screenshots/Pasted%20image%2020241224130440.png)
</Callout>
...
No worries if you don't understand the script. It's just a bunch of commands to get system information and **format it nicely**.
...
- `lscpu`: Displays information about the CPU architecture. We use it to get the **number of CPU sockets**.
  ...
  <Callout variant="info" title="What is a CPU socket?">
...
- `nproc`: Prints the number of processing units available to the current process. We use it to get the **number of virtual CPUs**.
  ...
  <Callout variant="info" title="What is a processing unit?">
...
![Good Job](/images/blog/articles/born2beroot/frieren_good_job.gif)

## Bonus Part ⭐

![Webmin Logo](/images/blog/articles/born2beroot/logos/webmin.webp)
...
<Callout variant="info" title="Webmin Screenshots">
![Webmin 1](/images/blog/articles/born2beroot/webmin/webmin_1.webp)
![Webmin 2](/images/blog/articles/born2beroot/webmin/webmin_2.webp)
![Webmin 3](/images/blog/articles/born2beroot/webmin/webmin_3.webp)
</Callout>
