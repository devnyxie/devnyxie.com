...
> [!info] > `Ctrl + b` is the default prefix key for TMUX. This means that you need to press `Ctrl + b` before any other command in TMUX.
...
### All other sessions (from inside of a session)
