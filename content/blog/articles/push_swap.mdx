---
title: "push_swap: Bitwise Radix Sort in C"
tags:
  - c
  - algorithm
  - project
...
image: /images/blog/articles/push_swap/thumbnail.png
...
- Basic understanding of `Linked List` and `Stack` data structures
...
<Callout variant="warning">
  It is very important to understand that we are sorting based on binary
  representation of the **indices** of the numbers in the `a` stack, not the
  numbers themselves. If you are confused, I recommend you to going through
  **visualizing the algorithm** section.
</Callout>
