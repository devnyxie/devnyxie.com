...
<template>
  <div class="flex flex-col items-center justify-center gap-4">
    ...
    <div clas="mt-4 flex-col justify-center items-center">
      <Motion
        :initial="{
          scale: 1.1,
          opacity: 0,
      ...
      >
        <div
          v-if="page.hero.link || global.available != undefined"
          class="flex items-center gap-2"
        >
          <UButton v-if="page.hero.link" v-bind="page.hero.link" />
          <UButton
            :color="global.available ? 'success' : 'error'"
            variant="ghost"
            class="gap-2"
            :to="global.available ? global.meetingLink : ''"
            :label="global.available ? 'Available' : 'Not available'"
          >
            <template #leading>
