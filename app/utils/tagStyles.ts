export interface TagStyleVariant {
  bg: string;
  border: string;
  text: string;
  hoverBg: string;
...
const defaultStyles: TagStyleVariant = {
  bg: "bg-accented",
  border: "border-muted",
  text: "text-muted",
  hoverBg: "hover:bg-accented/80",
};

const languagesStyles: Record<string, TagStyleVariant> = {
  javascript: {
    bg: "bg-yellow-500/10",
...
const frameworksStyles: Record<string, TagStyleVariant> = {
  react: {
    bg: "bg-blue-400/10",
...
const backendStyles: Record<string, TagStyleVariant> = {
  nodejs: {
    bg: "bg-green-600/10",
...
const devopsStyles: Record<string, TagStyleVariant> = {
  docker: {
    bg: "bg-blue-500/10",
    border: "border-blue-500/30",
    text: "text-blue-600 dark:text-blue-400",
...
const topicsCategoriesStyles: Record<string, TagStyleVariant> = {
  algorithm: {
    bg: "bg-purple-500/10",
...
export type TagVariant = "default" | "outline" | "subtle";
...
export const getTagStyles = (
  ...
  const colorMap: Record<string, TagStyleVariant> = {
