...
const posts = [
  {
    title: "Internalizing the Web",
    description:
      "A guide to building a personal knowledge base in order to internalize the web.",
    date: "2023-10-01",
  ...
  {
    title: "The Art of Note-Taking (Extended)",
    description: "Techniques and tools for effective note-taking.",
    date: "2023-09-15",
    link: "/posts/the-art-of-note-taking",
    image:
      "https://i.pinimg.com/736x/47/07/7a/47077afadae63d23218df3b9920b639b.jpg",
    tags: ["knowledge", "note-taking"],
    folder: "Knowledge",
  },
  {
    title: "Building a Digital Garden",
    description: "Creating a personal space for your thoughts and ideas.",
    date: "2023-08-20",
...
export default function Home() {
  return (
    <div className="w-full flex justify-center py-4">
      <div className="container-small mt-16">
        <div className="text-3xl font-bold mb-1">Sumi Library</div>
